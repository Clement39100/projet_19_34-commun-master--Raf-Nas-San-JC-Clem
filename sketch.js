...
function setup() {
  ...
  const medias = ["none",
    ...
    "webcam:0", "webcam:1", "meteo/accident.jpg", "meteo/accident2.jpg", "meteo/paneau.png", "meteo/attention.png", "meteo/soleil.jpg", "meteo/azkaban.jpg", "meteo/transat.jpg", "meteo/dobby.jpg", "meteo/Carte.jpg", "meteo/manif1.jpg", "lesAnges/intro.jpg", "JT/JT.jpg"
  ]
...
//	timeStarted = temps;
	...
	"Il a été prouvé que Tom a des ambitions de dominer la France.",
	"Les chats de Sandra ont été retrouvés mêler dans une sale affaire de drogue.",
	"Jean-Charles aurait préferé être blanc, indique sa petite amie.",
...
function drawBanniere(){
	...
	text(phrases[num_phrase], 320, 405)
}